...
class Login_input(BasePage):
    ...
    placeholder_login = (By.XPATH,"//*[@class='popup-singin']")
    input_login_in_placeholder = (By.XPATH,"//*[@id='USER_LOGIN_POPUP']")
    input_password_in_placeholder = (By.XPATH,"//*[@id='USER_PASSWORD_POPUP']")
    block_error = (By.XPATH,"//*[@class='filter block error']")
    login_button_in_placeholder = (By.XPATH,"//*[@data-type='phone']")


    def find_and_click_login(self):
